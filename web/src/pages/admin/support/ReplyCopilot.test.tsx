...
vi.mock("@/services/supportService",()=>({
 ...
 getSupportWorkspace:vi.fn().mockResolvedValue({case:{id:3},order:null,activeSuggestion:null,outboundMessages:[],diagnostics:{messageCount:1,suggestionCount:1,outboundCount:0}}),
