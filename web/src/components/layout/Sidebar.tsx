  ...
  return (
    <>
      ...
      <aside
        ...
        ref={(el) => {
          if (!el) return;
          if (navigationHidden) el.setAttribute("inert", "");
        ...
        {navigationHidden ? null : (
          <>
            ...
            <div className="space-y-3 py-3">
              <nav
                aria-label="工作区快捷入口"
                className="rounded-[var(--merchant-radius-md)] border border-white/10 bg-white/[0.05] p-2.5"
              >
                <p className="px-1 pb-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-400">
                  工作区
                </p>
                <button
                  type="button"
                  className="flex w-full items-center gap-3 rounded-lg bg-[var(--merchant-cyan)] px-3 py-2.5 text-left font-semibold text-[var(--merchant-navy)] transition-colors hover:bg-[#43d2df]"
                  onClick={() => {
              ...
              <div>
                <label
                  ...
                  className="px-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-400"
                >
                  历史会话
                </label>
                <div className="mt-2">
